...
au BufNewFile,BufRead *.c,*.cpp set textwidth=79  "行最大宽度
au BufNewFile,BufRead *.c,*.cpp  set expandtab       "tab替换为空格键
au BufNewFile,BufRead *.c,*.cpp  set autoindent      "自动缩进
au BufNewFile,BufRead *.c,*.cpp  set fileformat=unix   "保存文件格式
...
exe 'hi CursorLine   cterm=bold ctermbg=DarkGray  guifg=fg guibg=fg'
" exe 'hi CursorLine   cterm=bold ctermbg=LightGray ctermfg=0 gui=underline guifg=green'
